...
class colleagueElement:
    ...
    colleagueFirstLevel_1 = (By.XPATH, '/html/body/div[1]/section/section/aside/div/div[1]/div[1]/div/ul/li[2]/div')
    # 同事二级菜单
    colleagueSecondLevel = (
    By.XPATH, '//*[@id="app"]/section/section/aside/div/div[1]/div[1]/div/ul/li[2]/ul/li/ul/li[1]')
    # 同事  用户名称输入框/html/body/div[1]/section/section/main/div/div[1]/div[1]/form/div[1]/div/div/div/input
    username = (By.XPATH, '/html/body/div[1]/section/section/main/div/div[1]/div[1]/form/div[1]/div/div/div/input')
    # 重置
    reset=(By.XPATH,'/html/body/div[1]/section/section/main/div/div[1]/div[1]/form/div[4]/button[2]/span')
    # 同事 查询按钮
    ...
    # 详情的备注/html/body/div[1]/section/section/main/div/div[2]/div[1]/div[1]/div[2]/div/div[2]/form/div[19]/div/div/div/input
    remark = (By.XPATH,
    ...
    # 新增中的保存//*[@id="app"]/section/section/main/div/div[1]/button
    ...
    # 补充 /html/body/div[2]/div[8]/div/div[1]/div/ul/li[2]  坑啊，单独跑是8 同事整个合起来是9
    buchong = (By.XPATH, '/html/body/div[2]/div[12]/div/div[1]/div/ul/li[2]')
    # qq
    ...
    # 团队中的编辑
    team_edit = (By.XPATH, '/html/body/div[2]/div[15]/div/div[1]/div/ul/li')
    # 编辑中的第一个添加
    team_add=(By.XPATH,'/html/body/div[1]/section/section/main/div/div[2]/div/div/div/div/div/div[1]/div/div[2]/div[2]/div/div/div[1]/div[3]/div/div[1]/div/table/tbody/tr[1]/td[4]/div/button[1]/span')
    # 编辑删除中的确定
    team_sure=(By.XPATH,'/html/body/div[5]/div/div/div[3]/button[2]/span')
    # 编辑中的保存
    team_save=(By.XPATH,'//*[@id="app"]/section/section/main/div/div[2]/div/div/footer/span/button[2]/span')
    # 编辑中的第一个删除
    team_delete=(By.XPATH,'//div[3]/div/div[1]/div/table/tbody/tr[1]/td[4]/div/button[2]/span')
